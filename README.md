...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create whoareyou-83b5
  fly apps create whoareyou-83b5-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app whoareyou-83b5
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app whoareyou-83b5-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'whoareyou-83b5-staging' does not match app name in config file 'whoareyou-83b5'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name whoareyou-83b5-db
  fly postgres attach --app whoareyou-83b5 whoareyou-83b5-db

  fly postgres create --name whoareyou-83b5-staging-db
  fly postgres attach --app whoareyou-83b5-staging whoareyou-83b5-staging-db
  ```
